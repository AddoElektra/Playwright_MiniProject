...
test('cart', async ({ page }) => {
  //test.setTimeout(60000);
  await page.goto('https://www.amazon.in/');
  await page.locator('div[class=" nav-progressive-attribute"]').click();
  //await page.waitForLoadState('networkidle');
  await expect(page.locator('div[class="a-row sc-your-amazon-cart-is-empty"]')).toHaveText('Your Amazon Cart is empty');
});